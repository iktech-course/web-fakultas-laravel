    ...
    <div class="header-bar d-flex justify-content-between">
        <div class="d-flex align-items-center">
            <a href="#" class="logo-icon me-3">
                ...
                <span class="big">
                    <img src="{{ asset('assets/dashboard/images/logo2-light.png') }}" height="24" class="logo-light-mode" alt="">
                    <img src="{{ asset('assets/dashboard/images/logo2-dark.png') }}" height="24" class="logo-dark-mode" alt="">
                </span>
            </a>
                    ...
                    <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3" style="min-width: 200px;">
                        <a class="dropdown-item d-flex align-items-center text-dark pb-3" href="profile.html">
                            ...
                            <div class="flex-1 ms-2">
                                <span class="d-block">Ichsan Khaliq Adyanda</span>
