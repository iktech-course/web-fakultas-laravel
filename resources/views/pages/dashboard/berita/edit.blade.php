    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 mt-4">
            <div class="card rounded shadow p-4 border-0">
                <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <textarea name="isi" class="form-control" id="editor" cols="30" rows="10">{!! $berita->isi !!}</textarea>
                            <div class="invalid-feedback">
