                ...
                <form class="needs-validation" novalidate>
                    <div class="row g-3">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="firstName" placeholder="Kode Mata Kuliah" value=""
                                required>
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="firstName" placeholder="Nama Mata Kuliah" value=""
                                required>
                            <div class="invalid-feedback">
                                Nama Mata Kuliah Harus Terisi
                            </div>
                        </div>
