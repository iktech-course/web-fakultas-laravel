                    ...
                    <div class="col-lg-6 col-md-6 mb-4 pb-2">
                        <div class="card blog blog-primary rounded border-0 shadow overflow-hidden">
                            <div class="card-body content">
                                <h5><a href="berita-detail.html" class="card-title title text-dark">{{ $item->nama_kegiatan }}</a></h5>
                                <div class="post-meta d-flex justify-content-between align-items-center mt-3">
                                    ...
                                    <a href="{{ route('landing.kegiatan.show', $item->id) }}" class="text-muted readmore">Detail Kegiatan <i class="uil uil-angle-right-b align-middle"></i></a>
                                </div>
                            </div>
                        </div>
                    </div><!--end col-->
